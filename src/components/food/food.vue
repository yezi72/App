    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="content">
          ...
          <div class="buy" v-show="!food.count || food.count===0" @click.stop.event="addFirst">加入购物车</div>
        </div>
...
// 通过定义events把子组件的数据传给父组件，实现子组件和父组件的通信
//    events: {
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .food
    ...
    .image-header
      ...
      width: 100%
      height: 0
      padding-top: 100% //设置height:0 和padding-top:100% 可让盒子变为高度与宽度相等的正方形
      img
        position: absolute
        top: 0
        left: 0
